...
timeout 1
@echo OFF
 start "" "%~dp0vvvv_50alpha35.18_x64\vvvv.exe"  /showexceptions 0 /allowmultiple /shutup  /o ..\CueTimeliner_MCP\MIDI_IN_Icon.v4p
@echo OFF
@echo --------------MidiLedsOut----------------
timeout 1
@echo OFF
 start "" "%~dp0vvvv_50alpha35.18_x64\vvvv.exe"  /showexceptions 0 /allowmultiple /shutup /o ..\CueTimeliner_MCP\MIDI_OUT_Icon.v4p